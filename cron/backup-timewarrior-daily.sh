...
fname="${HOME}/docs/_backups/timewarrior/working-time/$(date -v-1d +%F-%A)"
echo "$(timew balance ioki 2023-11-13 - today && timew summary :yesterday :ids && timew export ioki | tw-charts)" >"$fname"
