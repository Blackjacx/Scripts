...
brew "atac"                                       # A simple API client (postman like) in your terminal
...
brew "nmap"                                       # "Network Mapper" is an open source tool for network exploration and security auditing.
brew "node"
brew "npm"
brew "nvim"
brew "openssl"
...
brew "spotify-tui"                                # Spotify for the terminal written in Rust 🚀
brew "sshs"                                       # Terminal user interface for SSH
...
cask "periphery"                                  # A tool to identify unused code in Swift projects.
cask "portfolioperformance"                       # Depot tracking
cask "provisionql"
cask "qlstephen"
...
cask "scummvm"
cask "sf-symbols"                                 # 🔥
cask "signal"                                     # A secure messenger
cask "sketch"
# cask "skype"                                    # not used
cask "slack"
cask "spotify"
