...
BUNDLE_ID_PREFIX="com.fancy_company"
PUBLISHER_NAME="My Fancy Company"
INPUT_DIR="$1"
...
DOCSET_ID="$BUNDLE_ID_PREFIX.$PRODUCT_NAME"
...
DOCSET_PUBLISHER_ID    = "$BUNDLE_ID_PREFIX"
DOCSET_PUBLISHER_NAME  = "$PUBLISHER_NAME"
